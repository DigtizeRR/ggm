...
?>
<?php if ( function_exists( 'ggm_dashboard_user_is_administrator' ) && ggm_dashboard_user_is_administrator() ) include GGM_PLUGIN_DIR . 'templates/dashboard/admin/overview.php'; ?>
